...
**Review the documentation.** No account is needed to review the draft version of this NIST Specification. Simply follow [this link](https://github.com/usnistgov/ElectionGlossary) and enjoy at your leisure. However, if you wish to comment you must…
...
1. Fork a copy of USNISTGOV/ElectionGlossary to your own organization/personal space.
...
3. Issue a PR from your branch to the `post-public-comment` branch in USNISTGOV/ElectionGlossary.
