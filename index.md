...
- [absentee voting](#absentee-voting)
	...
	- [appropriate mark](#appropriate-mark)
...
- [B](#b)
	- [ballot](#ballot)
	- [ballot counting logic](#ballot-counting-logic)
	- [ballot data](#ballot-data)
	- [ballot display format](#ballot-display-format)
	- [ballot image](#ballot-image)
	- [ballot instructions](#ballot-instructions)
	- [ballot marking device](#ballot-marking-device)
	- [ballot marking target area](#ballot-marking-target-area)
	- [ballot measure](#ballot-measure)
	- [ballot measure option](#ballot-measure-option)
	- [ballot of record](#ballot-of-record)
	- [ballot on demand](#ballot-on-demand)
	- [ballot production](#ballot-production)
	- [ballot rotation](#ballot-rotation)
	- [ballot style](#ballot-style)
	- [barcode](#barcode)
	- [barcode reader](#barcode-reader)
	- [batch](#batch)
	- [batch fed scanner](#batch-fed-scanner)
	- [benchmark](#benchmark)
	- [blank ballot](#blank-ballot)
	- [candidate](#candidate)
	...
	- [central reporting device](#central-reporting-device)
	- [certification testing](#certification-testing)
	- [Ciphertext](#ciphertext)
	- [closed primary](#closed-primary)
	- [combined precinct](#combined-precinct)
	- [commercial-off-the-shelf](#commercial-off-the-shelf)
	- [Common Data Format](#common-data-format)
	- [Common Industry Format](#common-industry-format)
	- [comparison audit](#comparison-audit)
	- [component](#component)
	...
	- [contest](#contest)
	- [contest option](#contest-option)
	- [contest option position](#contest-option-position)
	- [contest option vote](#contest-option-vote)
	- [contest selection](#contest-selection)
	- [core logic](#core-logic)
	- [corrective action](#corrective-action)
	- [counted ballot](#counted-ballot)
	- [cross-party endorsement](#cross-party-endorsement)
	- [cryptographic end-to-end voting system](#cryptographic-end-to-end-voting-system)
	...
	- [direct recording electronic voting machine](#direct-recording-electronic-voting-machine)
	- [dynamic password](#dynamic-password)
	- [EAC](#eac)
	- [early voting](#early-voting)
	- [early voting center](#early-voting-center)
	- [elected office](#elected-office)
	- [election](#election)
	- [election certification](#election-certification)
	- [election day](#election-day)
	- [election definition](#election-definition)
	- [election definition medium](#election-definition-medium)
	- [election district](#election-district)
	- [election jurisdiction](#election-jurisdiction)
	- [election management system](#election-management-system)
	- [election official](#election-official)
	- [election programming](#election-programming)
	- [Election Results Reporting System](#election-results-reporting-system)
	- [election worker](#election-worker)
	- [electronic ballot delivery](#electronic-ballot-delivery)
	- [electronic ballot interface](#electronic-ballot-interface)
	- [electronic ballot return](#electronic-ballot-return)
	- [electronic device](#electronic-device)
	- [electronic poll book](#electronic-poll-book)
	- [electronic voter interface](#electronic-voter-interface)
	- [eligible voters](#eligible-voters)
	- [encryption](#encryption)
	- [endorsement](#endorsement)
	- [enhanced visual format](#enhanced-visual-format)
	- [error correction code](#error-correction-code)
	- [error rate](#error-rate)
	- [escalation of privilege](#escalation-of-privilege)
	- [exhausted ballot](#exhausted-ballot)
	- [expected mark](#expected-mark)
	- [Extensible Markup Language](#extensible-markup-language)
	- [extraneous mark](#extraneous-mark)
	- [failure](#failure)
	...
	- [locality](#locality)
	- [logic and accuracy testing](#logic-and-accuracy-testing)
	- [logic defect](#logic-defect)
	- [logical correctness](#logical-correctness)
	- [low/no dexterity mode](#lowno-dexterity-mode)
	- [machine unreadable mark](#machine-unreadable-mark)
	- [machine-readable mark](#machine-readable-mark)
	- [manually-marked paper ballot](#manually-marked-paper-ballot)
	- [manufacturer](#manufacturer)
	- [marginally machine-readable mark](#marginally-machine-readable-mark)
	- [marked ballot](#marked-ballot)
	- [military voter](#military-voter)
	- [misfeed rate](#misfeed-rate)
	- [module](#module)
	- [multi-factor authentication](#multi-factor-authentication)
	- [multi-seat contest](#multi-seat-contest)
	- [municipality](#municipality)
	- [N-of-M](#n-of-m)
	- [national certification test report](#national-certification-test-report)
	- [National Institute of Standards and Technology](#national-institute-of-standards-and-technology)
	- [non-party-specific contest](#non-party-specific-contest)
	- [non-user-serviceable failure](#non-user-serviceable-failure)
	- [nonpartisan office](#nonpartisan-office)
	- [nonpartisan primary](#nonpartisan-primary)
	- [nonvolatile memory](#nonvolatile-memory)
	- [notice of clarification](#notice-of-clarification)
	- [observational test](#observational-test)
	- [office](#office)
	- [open primary](#open-primary)
	- [open source](#open-source)
	- [optical scan](#optical-scan)
	- [overseas voter](#overseas-voter)
	- [overvote](#overvote)
	- [paper ballot](#paper-ballot)
	- [paper ballot sheet](#paper-ballot-sheet)
	- [paper ballot side](#paper-ballot-side)
	- [partisan office](#partisan-office)
	- [partisan primary](#partisan-primary)
	- [party-specific contest](#party-specific-contest)
	- [pattern voting](#pattern-voting)
	- [penetration testing](#penetration-testing)
	- [personal assistive device](#personal-assistive-device)
	...
	- [post-election audit](#post-election-audit)
	- [precinct](#precinct)
	- [precinct count](#precinct-count)
	- [precinct split](#precinct-split)
	- [presentable ballot style](#presentable-ballot-style)
	- [presidential primary election](#presidential-primary-election)
	- [primary election](#primary-election)
	- [privacy](#privacy)
	- [privacy enclosure](#privacy-enclosure)
	- [private key](#private-key)
	- [product standard](#product-standard)
	- [programmed device](#programmed-device)
	...
	- [read ballot](#read-ballot)
	- [recall issue with options](#recall-issue-with-options)
	- [recallable ballot](#recallable-ballot)
	- [recertification](#recertification)
	- [record](#record)
	- [recorded ballot](#recorded-ballot)
	- [recount](#recount)
	- [report](#report)
	- [report total error rate](#report-total-error-rate)
	- [reporting unit](#reporting-unit)
	- [reproducibility](#reproducibility)
	- [residual vote](#residual-vote)
	- [reviewed ballot](#reviewed-ballot)
	- [risk assessment](#risk-assessment)
	- [risk-limiting audit](#risk-limiting-audit)
	- [runoff election](#runoff-election)
	- [seat](#seat)
	- [second chance voting](#second-chance-voting)
	- [security analysis](#security-analysis)
	- [security controls](#security-controls)
	- [security strength](#security-strength)
	- [software independence](#software-independence)
	- [source code](#source-code)
	- [spear phishing](#spear-phishing)
	- [spoil](#spoil)
	- [spoiled ballot](#spoiled-ballot)
	- [standard](#standard)
	- [straight party override](#straight-party-override)
	- [straight party voting](#straight-party-voting)
	- [street segment data](#street-segment-data)
	- [support software](#support-software)
	- [symmetric cryptography](#symmetric-cryptography)
	- [system extent](#system-extent)
	- [t-coil](#t-coil)
	- [tabulate](#tabulate)
	- [tactile controls](#tactile-controls)
	...
	- [third-party logic](#third-party-logic)
	- [token](#token)
	- [touch screen voting machine](#touch-screen-voting-machine)
	- [town](#town)
	- [township](#township)
	- [undervote](#undervote)
	- [Uniformed and Overseas Citizens Absentee Voting Act](#uniformed-and-overseas-citizens-absentee-voting-act)
	- [UOCAVA voter](#uocava-voter)
	- [usability](#usability)
	- [usability testing](#usability-testing)
	- [user-serviceable failure](#user-serviceable-failure)
	- [valid vote](#valid-vote)
	- [validation](#validation)
	- [visual format](#visual-format)
	- [vote](#vote)
	- [vote center](#vote-center)
	- [vote for N of M](#vote-for-n-of-m)
	- [vote-by-mail](#vote-by-mail)
	- [vote-capture device](#vote-capture-device)
	- [voter](#voter)
	- [voter facing scanner](#voter-facing-scanner)
	- [voter intent](#voter-intent)
	- [voter intent standard](#voter-intent-standard)
	- [voter verifiable](#voter-verifiable)
	- [voter verification](#voter-verification)
	- [voter verified paper audit trail](#voter-verified-paper-audit-trail)
	- [voting device](#voting-device)
	- [voting method](#voting-method)
	- [voting process](#voting-process)
	- [voting session](#voting-session)
	- [voting station](#voting-station)
	- [voting system](#voting-system)
	- [voting system software](#voting-system-software)
	- [Voting System Test Lab](#voting-system-test-lab)
	- [white box testing](#white-box-testing)
	- [Wi-Fi](#wi-fi)
	- [Wide Area Network](#wide-area-network)
	- [wireless](#wireless)
	- [write-in option](#write-in-option)
...
Used in next VVSG
<a name="adjudication-requiredballot"></a>
...
Used in next VVSG
<a name="asymmetriccryptography"></a>
...
Used in next VVSG
<a name="ballotmarkingtargetarea"></a>
...
Used in next VVSG
<a name="cross-partyendorsement"></a>
...
Used in next VVSG
<a name="cryptographicend-to-endvotingsystem"></a>
...
Used in next VVSG
<a name="directrecordingelectronicvotingmachine"></a>
...
Used in next VVSG
<a name="electioncertification"></a>
...
Used in next VVSG
<a name="electiondefinitionmedium"></a>
...
Used in next VVSG
<a name="electionmanagementsystem"></a>
...
Used in next VVSG
<a name="ElectionResultsReportingSystem"></a>
...
Used in next VVSG
<a name="electronicballotdelivery"></a>
...
Used in next VVSG
<a name="electronicballotinterface"></a>
...
Used in next VVSG
<a name="electronicballotreturn"></a>
...
Used in next VVSG
<a name="electronicvoterinterface"></a>
...
Used in next VVSG
<a name="escalationofprivilege"></a>
...
Used in next VVSG
<a name="FederalInformationProcessingStandards"></a>
...
Used in next VVSG
<a name="FunctionalConfigurationAudit"></a>
...
Used in next VVSG
<a name="GeographicalInformationSystem"></a>
...
Used in next VVSG
<a name="IntrusionDetectionSystem"></a>
...
Used in next VVSG
<a name="IntrusionPreventionSystem"></a>
...
Used in next VVSG
<a name="logicandaccuracytesting"></a>
...
Used in next VVSG
<a name="manually-markedpaperballot"></a>
...
Used in next VVSG
<a name="marginallymachine-readablemark"></a>
...
Used in next VVSG
<a name="nationalcertificationtestreport"></a>
...
Used in next VVSG
<a name="NationalInstituteofStandardsandTechnology"></a>
...
Used in next VVSG
<a name="non-party-specificcontest"></a>
...
Used in next VVSG
<a name="non-user-serviceablefailure"></a>
...
Used in next VVSG
<a name="party-specificcontest"></a>
...
Used in next VVSG
<a name="PersonalIdentifiableInformation"></a>
...
Used in next VVSG
<a name="PhysicalConfigurationAudit"></a>
...
Used in next VVSG
<a name="presentableballotstyle"></a>
...
Used in next VVSG
<a name="presidentialprimaryelection"></a>
...
Used in next VVSG
<a name="PublicKeyInfrastructure"></a>
...
Used in next VVSG
<a name="recallissuewithoptions"></a>
...
Used in next VVSG
<a name="straightpartyoverride"></a>
...
Used in next VVSG
<a name="touchscreenvotingmachine"></a>
...
Used in next VVSG
<a name="UniformedandOverseasCitizensAbsenteeVotingAct"></a>
...
Used in next VVSG
<a name="user-serviceablefailure"></a>
